...
if (!db) db = new Database(fs.readFile("/home/airbot/bigdb.sqlite"));

// Declare Methods
var methods = {
    fetch: require("quick.db/src/methods/fetch"),
    set: require("quick.db/src/methods/set"),
    add: require("quick.db/src/methods/add"),
    subtract: require("quick.db/src/methods/subtract"),
    push: require("quick.db/src/methods/push"),
    delete: require("quick.db/src/methods/delete"),
    has: require("quick.db/src/methods/has"),
    all: require("quick.db/src/methods/all"),
    type: require("quick.db/src/methods/type"),
};
...
module.exports = {
     ...
     */
    version: require("quick.db/package.json").version,
